...
urlpatterns = [
    ...
    path("docs/GettingStudentinfo",
     ...
     path("docs/SettingStudentinfo",
         views.settingStudentinfo, name="settingStudentinfo"),
    ...
    path("docs/GettingInstructorsInfo", views.gettingInstructorsInfo,
     ...
     path("docs/SettingInstructorsInfo", views.settingInstructorsInfo,
         name="settingInstructorsInfo"),
    path("delete_channel/<str:channel_id>",
         views.delete_channel_view, name="delete_channel"),
