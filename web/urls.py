...
urlpatterns = [
    ...
    path("docs/gettingInstructorsDepartment", views.gettingInstructorsDepartment,
         name="gettingInstructorsDepartment"),
    path("docs/GettingStudentDepartment", views.gettingStudentDepartment,
         name="gettingStudentDepartment"),
    path("docs/Instructors", views.instructors,
         name="instructors"),
    path("docs/GettingInstructorsInfo", views.gettingInstructorsInfo,
         name="gettingInstructorsInfo"),
    path("delete_channel/<str:channel_id>",
         views.delete_channel_view, name="delete_channel"),
